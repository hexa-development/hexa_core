...
Config.UpdateInterval = 5 -- ความถี่ในการบันทึกข้อมูลผู้เล่นทั้งหมดลงฐานข้อมูลอัตโนมัติ (หน่วยเป็นนาที) ยิ่งน้อยยิ่งบันทึกบ่อยแต่ก็ยิ่งเพิ่มภาระฐานข้อมูล
...
Config.Player.PlayerDefaults = {
    citizenid = function() -- citizen id ประจำตัวละคร (คำนำหน้า + เลขสุ่ม ตาม Config.Player.CitizenIdPrefix/Digits)
        return HexaCore.Player.CreateCitizenId()
    end,
